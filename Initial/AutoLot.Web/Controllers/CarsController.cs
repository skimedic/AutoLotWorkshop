...
namespace AutoLot.Web.Controllers
{
    ...
    public class CarsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Cars.Include(c => c.MakeNavigation);
        ...
        {
            ViewData["MakeId"] = new SelectList(_context.Makes, nameof(Make.Id), nameof(Make.Name));
            return View();
        }
        ...
        [HttpPost("{id}")]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MakeId,Color,PetName,Id,TimeStamp")]
            Car car)
        {
            if (id != car.Id)
            {
